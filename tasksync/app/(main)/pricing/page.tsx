      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
        <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
          <div className="p-6 sm:px-8">
            ...
            <p className="mt-2 text-white">
              Basic real-time collaboration for individuals, small teams or
              start-ups. Includes core features, limited users, and basic
              support.
            </p>
        ...
        <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
          <div className="p-6 sm:px-8">
            ...
            <p className="mt-2 text-white">
              Advanced collaboration tools for growing businesses. More users,
              enhanced features, priority support, and increased storage.
            </p>
        ...
        <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
          <div className="p-6 sm:px-8">
            ...
            <p className="mt-2 text-white">
              Customizable solution for large organizations. Even more users,
              full feature set, dedicated support, advanced security, and
              integration options.
            </p>
